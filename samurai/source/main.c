...
// Asset handles
gs_asset_t tex_samurai_stand_hndl= {0};
gs_asset_t tex_samurai_clash_hndl = {0};
...
void init()
{
    ...
    gs_asset_texture_t tex_samurai_stand = {0};
    gs_asset_texture_t tex_samurai_clash = {0};
    ...
    // Load asset data
    gs_asset_texture_load_from_file("./assets/stand.png", &tex_samurai_stand, NULL, false, false);
    gs_asset_texture_load_from_file("./assets/clash.png", &tex_samurai_clash, NULL, false, false);
    ...
    tex_samurai_stand_hndl = gs_assets_create_asset(&gsa, gs_asset_texture_t, &tex_samurai_stand);
    tex_samurai_clash_hndl = gs_assets_create_asset(&gsa, gs_asset_texture_t, &tex_samurai_clash);
...
void update()
{
    ...
    count += platform->time.delta;
        gs_println("time: %f, %f", 1/platform->time.delta, count);
    ...
    gs_asset_texture_t* tp_stand = gs_assets_getp(&gsa, gs_asset_texture_t, tex_samurai_stand_hndl);
